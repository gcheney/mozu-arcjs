...
var actionName = 'http.commerce.customer.accounts.addAccountAndLogin.after';

describe('http.commerce.customer.accounts.addAccountAndLogin.after implementing http.commerce.customer.accounts.addAccountAndLogin.after', function () {

  var action;

  before(function () {
    action = require('../src/domains/commerce.customer/http.commerce.customer.accounts.addAccountAndLogin.after');
  });
